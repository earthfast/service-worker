...
export abstract class AssetGroup {
  ...
  constructor(
      protected fetcher: Fetcher, protected adapter: Adapter, protected idle: IdleScheduler,
      protected config: AssetGroupConfig, protected hashes: Map<string, string>,
      protected db: Database, cacheNamePrefix: string) {
